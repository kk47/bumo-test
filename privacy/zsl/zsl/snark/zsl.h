...
extern "C" {
    ...
    /*
    void get_new_address(void *a_sk, void *a_pk);
    void get_randomness(void *hash);
    void root();
    void get_proof_from_hex(void *hex, void *proof);
    void get_witness(void *witness);
    
    void compute_send_nullifier(void *rho, void *send_nf);
    void compute_spend_nullifier(void *rho, void *sk, void *spend_nf);
    void compute_commitment(void *rho, void *pk, uint64_t value, void *cm);
    void 
