...
!function ($) {
            ...
            $.each(columns, function (j, column) {
                ...
                html.push('<th' + sprintf(' title="%s"', column.titleTooltip),
                    column.checkbox || column.radio ?
                        sprintf(' class="bs-checkbox %s"', column['classes'] || '') :
                        class_,
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [that.options.cardView ?
                        '<div class="card-view">' : '<td class="bs-checkbox '+(column.classes || '')+'">',
                        '<input' +
                        sprintf(' data-index="%s"', i) +
        ...
        if (!html.length) {
            html.push('<tr class="no-records-found">',
                sprintf('<td colspan="%s">%s</td>',
                    this.$header.find('th:not(.hide)').length, this.options.formatNoMatches()),
                '</tr>');
        }
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        }).find('table').html('').attr('class', this.$el.attr('class'))
            .append(this.$header_);
